...
namespace QLMP.Forms
{
    public partial class Hanghoa : Form
    {
        ...
        // MaHang, TenHang, MaLoai,MaNCC, ThuongHieu, QuocGia, CongDung, KhoiLuong, DonGiaNhap, DonGiaBan, Anh, GhiChu
        private void Hanghoa_Load(object sender, EventArgs e)
        {
            ...
            function.Fillcombo("SELECT MaNCC, TenNCC FROM NhaCungCap", combo_ncc, "MaNCC", "TenNCC");
        ...
        {
            string sql;
            sql = "SELECT a.MaHang, a.TenHang, a.MaLoai, b.MaNCC, a.ThuongHieu, a.QuocGia, a.CongDung, a.KhoiLuong,a.SoLuong, a.DonGiaNhap, a.DonGiaBan FROM Hang as a join NhaCungCap as b on a.MaNCC = b.MaNCC";
            ...
            datagridview_hanghoa.Columns[3].HeaderText = "Mã nhà cung cấp";
            datagridview_hanghoa.Columns[4].HeaderText = "Thương hiệu";
            datagridview_hanghoa.Columns[5].HeaderText = "Quốc gia";
            datagridview_hanghoa.Columns[6].HeaderText = "Công dụng";
            datagridview_hanghoa.Columns[7].HeaderText = "Khối lượng";
            datagridview_hanghoa.Columns[8].HeaderText = "Số lượng";
            datagridview_hanghoa.Columns[9].HeaderText = "Đơn giá nhập";
            datagridview_hanghoa.Columns[10].HeaderText = "Đơn giá bán";
        ...
        private void datagridview_hanghoa_Click(object sender, EventArgs e)
        {
            ...
            // MaHang, TenHang, MaLoai, MaNCC, ThuongHieu, QuocGia, CongDung, KhoiLuong,SoLuong, DonGiaNhap, DonGiaBan, Anh, GhiChu
            ...
            mancc = datagridview_hanghoa.CurrentRow.Cells["MaNCC"].Value.ToString();
            combo_ncc.Text = function.GetFieldValues("SELECT TenNCC FROM NhaCungCap WHERE MaNCC = N'" + mancc + "'");
        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT count(*) FROM Hang";
            ...
            if (result != DBNull.Value)
            {
                ...
                txt_mahang.Text = (genCode(maxMH+ 1));
            }
            else
            {
        ...
        public string genCode(int maxMH)
        {
            int count = 7 - maxMH.ToString().Length;
            string rs = "H";
        ...
        private void btn_luu_Click(object sender, EventArgs e)
        {
            ...
            if (combo_ncc.Text.Trim().Length == 0)
            {
                MessageBox.Show("Bạn phải chọn tên nhà cung cấp", "Thông báo", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning);
                combo_ncc.Focus();
                return;
            }
            // (MaHang, TenHang, MaLoai,MaNCC, ThuongHieu, QuocGia, CongDung, KhoiLuong,SoLuong, DonGiaNhap, DonGiaBan, Anh, GhiChu
            ...
            sql = "INSERT INTO Hang(MaHang, TenHang, MaLoai,MaNCC, ThuongHieu, QuocGia, CongDung, KhoiLuong, SoLuong, DonGiaNhap, DonGiaBan, Anh, GhiChu) VALUES(N'" + txt_mahang.Text.Trim() + 
                "', N'" + txt_ten.Text.Trim() + "', N'" + combo_maloai.SelectedValue.ToString() + "', N'" + combo_ncc.SelectedValue.ToString() + "', N'" +
                txt_thuonghieu.Text.Trim() + "', N'" + txt_quocgia.Text + "', N'" + txt_congdung.Text + "', N'" + 
                txt_khoiluong.Text + "', N'" + txt_sl.Text.Trim() + "', N'" + txt_dgnhap.Text.Trim() + "', N'" +
                txt_dgban.Text.Trim() + "', '" + txt_anh.Text + "', N'" + txt_ghichu.Text.Trim() + "')";
        ...
        private void btn_sua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE Hang SET TenHang=N'" + txt_ten.Text.Trim().ToString() +
                ...
                "',MaNCC=N'" + combo_ncc.SelectedValue.ToString()+
        ...
        private void btn_tk_Click(object sender, EventArgs e)
        {
            ...
            // Tìm kiếm theo nhiều trường: MaHang, TenHang, MaLoai,MaNCC, ThuongHieu, QuocGia, DonGiaNhap, DonGiaBan
            if (txt_tk.Text == "Nhập từ khóa để tìm kiếm" || txt_tk.Text.Length == 0 )
            {
       ...
       //     sql = "SELECT * FROM Hang as a join Loai as b  on a.MaLoai=b.MaLoai WHERE 1=1 ";
           sql = "SELECT a.MaHang, a.TenHang, b.TenLoai,c.TenNCC, a.ThuongHieu, a.QuocGia, a.CongDung, a.KhoiLuong,a.SoLuong, a.DonGiaNhap, a.DonGiaBan  FROM Hang as a JOIN Loai as b ON a.MaLoai = b.MaLoai JOIN NhaCungCap as c ON a.MaNCC = c.MaNCC WHERE 1=1";
            if (txt_tk.Text != "Nhập từ khóa để tìm kiếm")
            {
                ...
                foreach (string searchKey in searchKeys)
                {
                    ...
                    {
                        sql += " AND (a.MaHang LIKE N'%" + searchKey + "%' OR a.CongDung LIKE N'%" + searchKey+ "%' OR a.TenHang LIKE N'%" + searchKey + "%' OR b.TenLoai LIKE N'%" + searchKey + "%' OR c.TenNCC LIKE N'%" + searchKey + "%' OR a.ThuongHieu LIKE N'%" + searchKey + "%' OR a.QuocGia LIKE N'%" + searchKey + "%' OR a.DonGiaNhap LIKE N'%" + searchKey + "%' OR a.DonGiaBan LIKE N'%" + searchKey + "%')";
                    }
                }
            }
            ...
            if (this.combox_sx.SelectedItem != null)
            {
                ...
                switch (selectedItem)
                {
                    ...
                    case "Số lượng":
                        ...
                        MessageBox.Show("Sắp xếp thành công", "Thông báo", MessageBoxButtons.OKCancel, MessageBoxIcon.Information);
                        break;
                    // không sắp xếp theo khối lượng do kiểu dữ liệu nvarchar
                    //case "Khối lượng":
